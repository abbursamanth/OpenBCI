class DirectoryManager {
    ...
    private final String guiDataPath = System.getProperty("user.home")+File.separator+"Documents"+File.separator+"Cognisync_GUI"+File.separator;
    ...
    public void init() {
        ...
        if (guiv4_fileToCheck.exists()) {
            ...
            try {
                ...
                println("Cognisync_GUI::Setup: Successfully deleted old GUI v4 sample data files!");
            } catch (SecurityException e) {
                println("Cognisync_GUI::Setup: Error trying to delete old GUI Sample Data in Documents folder.");
            }
        }
        ...
        if (guiv5_fileToCheck.exists()) {
            ...
            try {
                ...
                println("Cognisync_GUI::Setup: Successfully deleted old GUI v5 sample data files!");
            } catch (SecurityException e) {
                println("Cognisync_GUI::Setup: Error trying to delete old GUI Sample Data in Documents folder.");
            }
        }
        ...
        if (!guiv6_fileToCheck.exists()) {
            ...
            println("Cognisync_GUI::Setup: GUI v6 Sample Data exists in Documents folder.");
        }
    ...
    private void copySampleDataFiles(File directory, String directoryName) {
        println("Cognisync_GUI::Setup: Copying sample data to Documents/Cognisync_GUI/Sample_Data");
        ...
        try {
            ...
            println("Cognisync_GUI::Setup: Error trying to copy Sample Data to Documents directory.");
        }
    }

    private void makeRecordingsFolder() {
        //Create \Documents\Cognisync_GUI\Recordings\ if it doesn't exist
        ...
        if (recDirectory.mkdir()) {
            println("Cognisync_GUI::Setup: Created \\Documents\\Cognisync_GUI\\Recordings\\");
        }
    }
